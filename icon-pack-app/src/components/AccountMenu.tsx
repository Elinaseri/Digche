    ...
    <div ref={rootRef} className="relative">
      ...
      {open && (
        <div
          role="menu"
          aria-label="Account menu"
          className="absolute right-0 mt-2 w-56 rounded-2xl bg-white dark:bg-ink-800 border border-ink-200 dark:border-ink-700 shadow-soft z-50 p-1.5"
        >
          {/* User info header */}
          <div className="px-3 py-2.5 border-b border-ink-100 dark:border-ink-700 mb-1">
            ...
            <div className="text-xs mt-0.5">
              {plan === "premium" ? (
                ...
                <span className="text-ink-400">Free plan</span>
              )}
            </div>
          </div>
